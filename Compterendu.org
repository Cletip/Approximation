...
** Méthode des droites de regression
...
Suite à cela, nous appliquerons la [[*Méthode des droites de regression][méthode des droites de regression]] avec les variables correspondantes.
...
* TODO Présentation des programmes commentés

Nous ne mettrons pas l'intégralité du code des différentes résolutions, mais ils sont consultables .
