...
Suite à cela, nous appliquerons la \hyperref[sec:org682519e]{méthode des droites de régression} avec les variables correspondantes.

\subsubsection{Question 3}
\label{sec:orgb57681e}
...
\label{sec:org3b0c77a}


\begin{enumerate}
\item Présentation du code général
\label{sec:org8b3ec69}
