...
\label{sec:org67dd9eb}


\subsection{Cas général des méthodes}
\label{sec:orgf0652df}
...
\subsection{Méthode des droites de regression}
\label{sec:orgde0db96}
...
\label{sec:org5ab8c70}




\subsubsection{Question 2}
\label{sec:orgb3617cc}

Nous appliquerons la même méthode que la méthode à la \hyperref[sec:org5ab8c70]{Question 1}.


\subsection{Méthode des ajustements}
\label{sec:orga5821cb}
...
Suite à cela, nous appliquerons la \hyperref[sec:orgde0db96]{méthode des droites de regression} avec les variables correspondantes.

\subsubsection{Question 3}
\label{sec:org75e86c0}
...
\label{sec:org53f9b49}

Cette fonction permet de faire la somme des différents Li trouvé dans la fonction \hyperref[sec:org43c5b56]{\emph{calculLi}}.
En effet, pour compléter la méthode de Lagrange, il faut faire une boucle \emph{for} qui fait une somme des \(y_i\) multiplier par \hyperref[sec:org43c5b56]{\emph{calculLi}} pour l'itération \(i\).
...
\label{sec:orge29ba0e}

\subsubsection{Affichage}
\label{sec:org873bb80}
